...
For households doing [Roth conversions](/articles/roth-conversion-decade) in early retirement, the conversion income raises provisional income, which can push more Social Security into the taxable column. The interaction:
...
5. How does each claiming combination interact with [Roth conversions](/articles/roth-conversion-decade), [IRMAA](/articles/qcds-explained), and other tax planning?
...
If you and your spouse are within 5 years of claiming and haven't done the analysis, [we'd be glad to model it for you](/contact).
