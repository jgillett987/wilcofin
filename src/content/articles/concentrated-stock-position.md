...
Gift the appreciated shares directly to a [donor-advised fund](/articles/donor-advised-funds) or a public charity. Avoids capital gains entirely, generates a deduction at fair market value, and lets you redirect what would have been a tax payment into your charitable giving plan. For households already planning meaningful giving, this is often the single best tool.
...
If you have a concentrated position you've been meaning to unwind but haven't, [we can model the tradeoffs](/contact) — the right path almost always combines several of these tools rather than picking one.
